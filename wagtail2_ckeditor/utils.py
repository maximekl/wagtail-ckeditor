...
from wagtail.core.whitelist import Whitelister, allow_without_attributes, attribute_rule
from wagtail2_ckeditor.wagtail_hooks import whitelister_element_rules
...
BASE_WHITELIST_RULES = {
    ...
    'a': attribute_rule({'href': True, "target": True, 'style':True, 'id': True, 'name': True}),
}
